    ...
    if (!isLoading) {
      if (htmlContent !== processedHtmlContentRef.current) {
        ...
        scripts.forEach((script) => {
          // Explicitly cast to HTMLScriptElement to resolve 'unknown' type errors
          const oldScript = script as HTMLScriptElement;
          try {
            const newScript = document.createElement('script');
            // Explicitly cast each attribute to Attr to resolve 'unknown' type errors
